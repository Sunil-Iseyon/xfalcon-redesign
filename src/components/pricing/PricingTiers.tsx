import { PRICING_FOOTNOTE, TIERS, tierFigures } from '@/content/pricing';
  ...
  return (
    <section className="section tiers-section" id="tiers">
      <div className="container-xf">
        {/* The hero used to introduce this grid directly. The AI model section
            now sits between them, so the tiers carry their own header. */}
        <div className="section-header">
          <p className="eyebrow">Platform pricing</p>
          <h2 className="heading-2">Three tiers, priced by analytical complexity</h2>
        </div>
          ...
          {TIERS.map((tier) => {
            ...
            return (
              <li
                key={tier.name}
                className={
                  tier.highlighted ? 'card tier-card tier-card-featured' : 'card tier-card'
                }
              >
                <div className="tier-head">
                  <h3 className="heading-3 tier-name">{tier.name}</h3>
                ...
                <p className="tier-per-user">
                  <span className="tier-per-user-value">{figures.perUser}</span>
                ...
                <dl className="tier-specs">
                  <div className="tier-spec">
                    ...
                    <dd className="tier-spec-value">
                      <span className="tier-spec-price">{figures.installation}</span>
                  ...
                  <div className="tier-spec">
                    ...
                    <dd className="tier-spec-value">
                      <span className="tier-spec-price">{figures.platform} / mo</span>
                ...
                <dl className="tier-specs tier-totals">
                  <div className="tier-spec">
                    ...
                    <dd className="tier-total-value">{figures.monthlyTotal}</dd>
                  </div>
                  <div className="tier-spec">
                    <dt className="tier-spec-label">Year 1 total</dt>
                    <dd className="tier-total-value">{figures.yearOne}</dd>
                  </div>
                </dl>
